...
Summary(pl.UTF-8):   Moduł captive dla gnome-vfs
Group:		Libraries
...
Moduł captive dla gnome-vfs.

%package install
Summary:	Windows filesystem drivers installer for captive
Summary(pl.UTF-8):   Instalator windowsowych sterowników systemu plików dla captive
...
Pakiet zawiera pliki nagłówkowe i biblioteki deweloperskie dla captive.
